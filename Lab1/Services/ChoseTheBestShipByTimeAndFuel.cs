...
public class ChoseTheBestShipByTimeAndFuel
{
    private readonly Route _route;
    private readonly IExchange _exchange;

    public ChoseTheBestShipByTimeAndFuel(Route route, IExchange exchange)
    {
        _route = route;
        _exchange = exchange;
    }
    ...
    public ExpeditionResult FindOptimalShip(ICollection<IShip> ships)
    {
        ...
        foreach (IShip ship in ships)
        {
            ...
            if (success.Time.Amount >= minPrice.Amount) continue;
